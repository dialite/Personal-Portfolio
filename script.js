...
const projects = [
...

  {
    ...
    cardImg: ["content-frame"],
    imgDetails: ["desktop-image-4", "frame-case-da", "column-two"],
    articleClassList: ["desktop-content", "column-one"],
    h2TitleClass: ["content"],
    name: "Figma Clone - Figsign",
    highlights: ["JSPDF", "Liveblocks", "2025"],
    stacks: ["TypeScript", "Tailwind CSS", "Next.JS"],
    tagline: ["Fabric.js", "Radix UI", "2025"],
    p: "A Figma-like real-time collaborative design application featuring interactive cursors, chat, reactions, active users list, comment bubbles, shape creation, undo/redo functionalities, clearing canvas, and exporting designs. Built with Next.js 14, Tailwind CSS, and Liveblocks.",
    description:
      "A Figma-like real-time collaborative design application featuring interactive cursors, live chat, emoji reactions, active users list, threaded comment bubbles, shape creation, undo/redo functionalities, canvas clearing, and design export options. Built using Next.js 14, Tailwind CSS, and Liveblocks for seamless synchronization, smooth user experience, and real-time collaboration at scale.",
    featuredImage: "img/figsign1.png",
    featuredImagetiny: "img/figsign1.png",
    liFormat: ["flex", "tool-content"],
    technologies: ["UUID", "Liveblocks", "Lucide-React"],
    live: "https://figsign.vercel.app/",
    source: "https://github.com/dialite/figsign.git",
  },
  {
    cardClass: ["grid-item", "second-desktop-switch", "anime"],
    cardImg: ["content-frame"],
    imgDetails: ["desktop-image-4a", "frame-case-d", "column-two"],
    articleClassList: ["desktop-content", "column-one"],
    h2TitleClass: ["content"],
    name: "Figma Clone - Figsign",
    highlights: ["JSPDF", "Liveblocks", "2025"],
...

  {
    cardClass: ["grid-item", "mobile-switch"],
    cardImg: ["content-frame"],
    imgDetails: ["desktop-image-3a", "frame-case-ca", "column-two"],
    articleClassList: ["desktop-content", "column-one"],
    h2TitleClass: ["content"],
    ...
    description:
      "A modern digital platform built for RCCG Living Seed Church, Abuja—crafted with Next.js, React, and TypeScript for scalability and performance. Styled using Tailwind CSS, tailwindcss-animate, and lucide-react, it features dynamic content delivery, smooth animations with Framer Motion, and accessible UI via Radix UI. Includes Calendly scheduling, slick carousels, animated headers, robust form handling, and secure email via Nodemailer.",
    featuredImagetiny: "img/lsc3a.png",
    featuredImage: "img/lsc3a.png",
    liFormat: ["flex", "tool-content"],
    technologies: ["Zod", "Nodemailer", "Framer-motion"],
    live: "https://rccglscabuja.vercel.app/",
    source: "https://github.com/dialite/rccglscabuja.git",
  },
  {
    cardClass: ["grid-item", "second-desktop-switch", "anime"],
    cardImg: ["content-frame"],
    imgDetails: ["desktop-image-3a", "frame-case-ca", "column-one"],
    articleClassList: ["desktop-content", "column-two"],
    h2TitleClass: ["content"],
    name: "RCCG Living Seed Church, Abuja",
    highlights: ["API", "Calendly", "Framer-Motion"],
    ...
    description:
      "A modern digital platform built for RCCG Living Seed Church, Abuja—crafted with Next.js, React, and TypeScript for scalability and performance. Styled using Tailwind CSS, tailwindcss-animate, and lucide-react, it features dynamic content delivery, smooth animations with Framer Motion, and accessible UI via Radix UI. Includes Calendly scheduling, slick carousels, animated headers, robust form handling, and secure email via Nodemailer.",
    featuredImagetiny: "img/lsc2.png",
    featuredImage: "img/lsc2.png",
    liFormat: ["flex", "tool-content"],
    rubyClass: ["ruby"],
    technologies: ["Zod", "Nodemailer", "Framer-motion"],
    live: "https://rccglscabuja.vercel.app/",
